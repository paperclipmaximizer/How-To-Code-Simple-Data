...
;; produces false if rocket's descent has ended; true still descending
(check-expect (has-landed? 100) true)
(check-expect (has-landed? 23) true)
(check-expect (has-landed? 0.25) true)
(check-expect (has-landed? false) false)
